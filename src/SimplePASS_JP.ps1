...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="SimplePASS - パスワード管理ツール" Height="560" Width="880"
    ...
    <Grid>
        ...
        <Grid x:Name="MainGrid" Visibility="Collapsed" Margin="15">
            ...
            <Grid Grid.Row="0" Margin="0,0,0,15">
                ...
                <Button x:Name="BtnLock" Grid.Column="2" Content="保管庫をロック" Height="35" Width="110" Margin="10,0,0,0"
            ...
            <DataGrid x:Name="DgEntries" Grid.Row="1" AutoGenerateColumns="False" IsReadOnly="True"
                ...
                <DataGrid.Columns>
                    <DataGridTextColumn Header="タイトル" Binding="{Binding title}" Width="160"/>
                    <DataGridTextColumn Header="ユーザー名 / ID" Binding="{Binding username}" Width="160"/>
                    <DataGridTextColumn Header="URL" Binding="{Binding url}" Width="180"/>
                    <DataGridTextColumn Header="メモ" Binding="{Binding note}" Width="140"/>
                    <DataGridTemplateColumn Header="操作" Width="*">
                        <DataGridTemplateColumn.CellTemplate>
                            <DataTemplate>
                                <StackPanel Orientation="Horizontal" HorizontalAlignment="Left">
                                    <Button Content="PASSコピー" Tag="{Binding password}" x:Name="BtnCopyPass" Margin="2" Padding="6,2" Background="#3498DB" Foreground="White" BorderThickness="0"/>
                                    <Button Content="IDコピー" Tag="{Binding username}" x:Name="BtnCopyUser" Margin="2" Padding="6,2" Background="#95A5A6" Foreground="White" BorderThickness="0"/>
                                    <Button Content="編集" x:Name="BtnEditEntry" Margin="2" Padding="6,2" Background="#F39C12" Foreground="White" BorderThickness="0"/>
                                    <Button Content="削除" x:Name="BtnDeleteEntry" Margin="2" Padding="6,2" Background="#E74C3C" Foreground="White" BorderThickness="0"/>
                                </StackPanel>
                            </DataTemplate>
                        </DataGridTemplateColumn.CellTemplate>
...
$btnLogin.Add_Click({
    ...
    try {
        ...
        if (Test-VaultExists) {
            $txtLoginError.Text = "マスターパスワードが正しくないか、復号化に失敗しました。"
        } else {
...
$window.AddHandler([System.Windows.Controls.Primitives.ButtonBase]::ClickEvent, [System.Windows.RoutedEventHandler]{
    ...
    if ($source.Name -eq "BtnCopyPass" -or $source.Content -eq "PASSコピー") {
